...
public class TaskContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS, TASKS); // 100, all tasks
        uriMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", TASKS_WITH_ID); // 101, an specific task by its id
        return uriMatcher;
    }
    // TODO (2) Define a static buildUriMatcher method that associates URI's with their int match
    public static final UriMatcher sUriMatches = buildUriMatcher();
